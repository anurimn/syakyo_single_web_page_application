...
spa.chat = (function(){
    ...
    // 動作：
    // このメソッドはスライダを要求された位置に移動する
    // 要求された位置が現在の位置の場合は、何もせずtrueを返す
    // 戻り値：
    //  * true - 要求された位置に移動した
    ...
    // 動作：
    //  指定された引数で内部構造データ構造(configMap)を更新する。その他の動作は行わない。
    // 戻り値： true
    // 例外発行： なし
    //
    ...
    handleResize = function(){
        ...
        // handleResizeが呼ばれるたびに、ピクセルサイズを再計算する
        setPxSizes();
        if (stateMap.position_type === 'opened'){
